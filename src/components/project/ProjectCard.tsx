...
export default function ProjectCard({ project }: ProjectCardProps) {
  ...
  return (
    <Link
      ...
      className="group block rounded-lg border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-indigo-300 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
    >
      ...
      <h3 className="mt-3 text-base font-semibold text-gray-900 group-hover:text-indigo-600">
        {project.name}
      </h3>
