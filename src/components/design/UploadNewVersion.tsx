      ...
      <div className="w-full max-w-lg rounded-lg bg-white p-6 shadow-xl">
        ...
        {designType === "IMAGE" ? (
          <div
            ...
            className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 p-8 hover:border-indigo-300 hover:bg-gray-100"
          >
            {preview ? (
        ...
        <div className="mt-4">
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2 text-sm placeholder:text-gray-400 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
          />
        </div>
