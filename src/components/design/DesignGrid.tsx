  ...
  if (designs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 py-16">
        ...
        <p className="mt-3 text-sm font-medium text-gray-600 dark:text-gray-300">No designs yet</p>
        <p className="mt-1 text-sm text-gray-400 dark:text-gray-500">Upload an image or create a markdown document</p>
        <button
          onClick={onUpload}
