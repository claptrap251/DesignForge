  ...
  return (
    <div>
      <div className="mb-4 flex items-center justify-between">
        ...
        <button
          onClick={onUpload}
          className="flex items-center gap-1.5 rounded-lg bg-indigo-600 px-3 py-1.5 text-sm font-medium text-white transition-colors hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
        >
